...
func (r *ServiceType) BeforeCreate(db *gorm.DB) (err error) {
...
func (r *ServiceType) BeforeSave(db *gorm.DB) (err error) {
	user, err := utils.GetUserIdentity(db.Statement.Context)
	if err != nil {
		return err
	}
...
func (r *ServiceType) BeforeDelete(db *gorm.DB) (err error) {
	user, err := utils.GetUserIdentity(db.Statement.Context)
	if err != nil {
		return err
	}
