...
func (Uom) ViewModel() string {
	...
	sql.WriteString("  r.uom_name,")
	sql.WriteString("  r.uom_code,")
	sql.WriteString("  r.uom_symbol,")
...
func (Uom) Migration() map[string]string {
	var view = Uom{}
