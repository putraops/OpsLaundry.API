...
func (ProductCategory) TableName() string {
	return "vw_product_category"
}

func (ProductCategory) ViewModel() string {
	...
	sql.WriteString("FROM product_category r ")
...
func (ProductCategory) Migration() map[string]string {
	var view = ProductCategory{}
